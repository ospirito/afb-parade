...
class AFBP_ShortlinkSettings
{
	...
	public function base_domain_callback()
	{
		...
		?>
		<input class="regular-text" type="text" name="afbp_shortlink_option_name[base_domain]" id="base_domain"
			value="<?php echo $value ?>">
		<p class="description">The root domain where shortlinks are hosted. For example, <code>https://short.example/</code> or
			<code><?php echo site_url('/s/'); ?></code>.</p>
		<?php
	}
	...
	public function default_params_callback()
	{
		...
		?>
		<input class="regular-text" type="text" name="afbp_shortlink_option_name[default_params]" id="default_params"
			value="<?php echo esc_attr($value) ?>">
		<p class="description">Comma-separated list of query parameter keys to pre-fill when creating a new shortlink (e.g.
			<code>utm_source,utm_medium,utm_campaign</code>).</p>
		<?php
	}
}
